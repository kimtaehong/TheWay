...
$(function(){
    ...
    function CenterControl(controlDiv, app_map) {
        ...
        controlUI2.style.marginRight = '3px';
    ...
    function CenterControl2(controlDiv2, app_map) {
        ...
        controlUI3.style.marginRight = '3px';
        controlUI3.style.marginBottom = '3px';
        controlUI3.style.textAlign = 'center';
        controlUI3.title = 'Fast Tracking';
        ...
        controlUI4.style.marginRight = '3px';
        ...
        controlUI5.style.marginRight = '3px';
